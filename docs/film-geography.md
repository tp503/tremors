...
```mermaid
flowchart TB
  cliffs["North cliffs<br/>last Graboid dies"]
  mountainsE["East mountains<br/>granite / jeep trails"]
  mountainsW["West mountains<br/>granite"]
  burt["Burt and Heather<br/>hilltop compound"]
  town["Town of Perfection<br/>Main Street N-S"]
  rocks["Boulder fields<br/>pole-vault rocks"]
  aqueduct["Concrete aqueduct / culvert<br/>first Graboid kill"]
  jim["Jim and Megan<br/>unfinished house"]
  edgar["Edgar's electrical pylon"]
  fred["Old Fred's sheep ranch"]
  road["Canyon road to Bixby<br/>rockslide / road crew"]
  bixby["South: Bixby ~38 miles"]
